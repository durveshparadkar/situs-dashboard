 ...
 */
export { HTTP_STATUS, HTTP_METHODS, HEADERS, CONTENT_TYPES, ERROR_CODES, PAGINATION, SORT_ORDERS, TIME, SIZE_LIMITS, COOKIE_NAMES, CACHE_KEY_PREFIXES, REGEX, SENSITIVE_FIELDS, ENVIRONMENTS, REQUEST_ID, API_VERSION, LOCALE_DEFAULTS, INR_THRESHOLDS, } from "../../config/constants.js";
// ============================================================
// RBAC VOCABULARY
// ============================================================
/**
 ...
 */
export { PERMISSIONS, PERMISSION_GROUP, PERMISSION_TO_GROUP, ROLES, ROLE_HIERARCHY, ROLE_PERMISSIONS, RESERVED_ROLE_NAMES, ALL_PERMISSIONS, ALL_ROLES, ALL_PERMISSION_GROUPS, isValidPermission, isValidRole, isValidPermissionGroup, normalizePermission, normalizeRole, getPermissionsForRole, roleHasPermission, getPermissionsInGroup, compareRoleAuthority, isSeniorRole, isReservedRoleName, } from "../../shared/rbac/permissions.js";
// ============================================================
// APP ERROR
// ============================================================
/**
...
export function rateLimitedError(retryAfter) {
    return new AppError("Too many requests", 429, "RATE_LIMITED", retryAfter !== undefined ? { retryAfter } : undefined);
}
/**
