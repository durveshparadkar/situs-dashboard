 ...
 */
router.post("/refresh", refreshLimiter, reqPerm("RUN_INTELLIGENCE"), intelligenceController.refresh);
/**
 * POST /api/intelligence/preview
 * Dry-run — same logic, no writes, no alerts.
 */
router.post("/preview", readLimiter, reqPerm("READ_INSIGHTS"), intelligenceController.preview);
/**
 * POST /api/intelligence/deals/:dealId/refresh
 * Re-score one deal.
 */
router.post("/deals/:dealId/refresh", dealRefreshLimiter, reqPerm("RUN_INTELLIGENCE"), intelligenceController.refreshDeal);
// ============================================================
// READ ROUTES
// ============================================================
/**
 ...
 */
router.get("/summary", readLimiter, requireActiveBillingReadOnly, reqPerm("READ_INSIGHTS"), intelligenceController.summary);
/**
 * GET /api/intelligence/forecast
 * Just the forecast view.
 */
router.get("/forecast", readLimiter, requireActiveBillingReadOnly, reqPerm("READ_INSIGHTS"), intelligenceController.forecast);
/**
 * GET /api/intelligence/leaks
 * Just the pipeline leaks view.
 */
router.get("/leaks", readLimiter, requireActiveBillingReadOnly, reqPerm("READ_INSIGHTS"), intelligenceController.leaks);
/**
 * GET /api/intelligence/actions
 * Just the revenue actions view.
 */
router.get("/actions", readLimiter, requireActiveBillingReadOnly, reqPerm("READ_INSIGHTS"), intelligenceController.actions);
