...
===================================================== */
async function safeWhatsAppSend(phone, template, variables) {
    try {
        await whatsappService.sendTemplateMessage(phone, template, variables);
    }
    catch (err) {
...
//# sourceMappingURL=lead.listener.js.map