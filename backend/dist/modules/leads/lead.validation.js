...
const optionalString = z.preprocess(cleanString, z.string().optional().nullable());
// Required clean string
const requiredString = z.preprocess(cleanString, z.string().min(1, "Field is required"));
