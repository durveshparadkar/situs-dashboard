...
async function ensureOrgAdminRole(session) {
...
====================================================== */
async function createDefaultPipeline(organizationId, session) {
...
class AuthService {
    ...
    async login(input) {
        ...
        const payload = {
            ...
            roleId: String(typeof user.roleId === "object" && "_id" in user.roleId
                ? user.roleId._id
                : user.roleId),
        };
        const accessToken = signAccessToken(payload);
