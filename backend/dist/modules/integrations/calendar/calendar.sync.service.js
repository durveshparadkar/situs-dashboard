...
class CalendarSyncService {
    /* =====================================================
       SYNC EVENTS
    ===================================================== */
    async syncEvents(accessToken) {
        calendarConnector.initialize(accessToken);
        const events = await calendarConnector.fetchEvents();
        const meetings = calendarMapper.mapEvents(events);
        return {
