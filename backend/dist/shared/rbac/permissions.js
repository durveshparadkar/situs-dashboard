 ...
 */
export const PERMISSION_TO_GROUP = {
    ...
    [PERMISSIONS.RUN_INTELLIGENCE]: PERMISSION_GROUP.INTELLIGENCE,
 ...
 */
export function isValidPermissionGroup(value) {
    if (typeof value !== "string")
        return false;
    return Object.values(PERMISSION_GROUP).includes(value);
}
/**
 ...
 */
export function getPermissionsInGroup(group) {
...
export const ALL_PERMISSION_GROUPS = Object.values(PERMISSION_GROUP);
