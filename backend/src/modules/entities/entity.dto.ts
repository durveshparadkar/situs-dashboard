...
export type ListEntitiesQueryInput = z.infer<typeof listEntitiesQuerySchema>;
...
export type BulkCreateEntitiesInput = z.infer<typeof bulkCreateEntitiesSchema>;
...
export type FindByExternalIdInput = z.infer<typeof findByExternalIdSchema>;
...
export const validateCreateEntity = (data: unknown): CreateEntityInput =>
  runSchema(createEntitySchema, data);

export const validateUpdateEntity = (data: unknown): UpdateEntityInput =>
  runSchema(updateEntitySchema, data);

export const validateListEntitiesQuery = (
  data: unknown
): ListEntitiesQueryInput => runSchema(listEntitiesQuerySchema, data);

export const validateBulkCreateEntities = (
  data: unknown
): BulkCreateEntitiesInput => runSchema(bulkCreateEntitiesSchema, data);

export const validateFindByExternalId = (
  data: unknown
): FindByExternalIdInput => runSchema(findByExternalIdSchema, data);
...
export type ListEntitiesQuery = ListEntitiesQueryInput;