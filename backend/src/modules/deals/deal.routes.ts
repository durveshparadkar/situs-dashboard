...
router.post(
  "/",
  WRITE_LIMIT,
  reqPerm("CREATE_DEAL", "READ_DEAL"),
  asyncHandler((req, res, next) =>
    DealController.createDeal(req, res, next)
  )
);
...
router.post(
  ...
  reqPerm("CREATE_DEAL", "READ_DEAL"),
  asyncHandler((req, res, next) =>
    DealController.importDeals(req, res, next)
  )
);
...
router.get(
  ...
  reqPerm("READ_DEAL"),
  asyncHandler((req, res, next) =>
    DealController.getDeals(req, res, next)
  )
);
...
router.get(
  ...
  reqPerm("READ_DEAL"),
  asyncHandler((req, res, next) =>
    DealController.getDealById(req, res, next)
  )
);
...
router.patch(
  ...
  reqPerm("UPDATE_DEAL"),
  asyncHandler((req, res, next) =>
    DealController.updateDeal(req, res, next)
  )
);
...
router.patch(
  ...
  reqPerm("UPDATE_DEAL"),
  asyncHandler((req, res, next) =>
    DealController.updateDealStage(req, res, next)
  )
);
...
router.delete(
  ...
  reqPerm("DELETE_DEAL"),
  asyncHandler((req, res, next) =>
    DealController.deleteDeal(req, res, next)
  )
);
