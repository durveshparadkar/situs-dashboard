...
router.get(
  ...
  asyncHandler((req, res, next) =>
    insightController.getMyInsights(req, res, next)
  )
);
...
router.get(
  "/stats",
  STATS_LIMIT,
  authorize("READ_INSIGHT"),
  asyncHandler((req, res, next) =>
    insightController.getStats(req, res, next)
  )
);
...
router.post(
  ...
  EXPIRE_LIMIT,
  requireManager,
  authorize("ADMIN_INSIGHT"),
  asyncHandler((req, res, next) =>
    insightController.expireStale(req, res, next)
  )
);
...
router.post(
  ...
  authorize("ADMIN_INSIGHT"),
  asyncHandler((req, res, next) =>
    insightController.bulkCreate(req, res, next)
  )
);
...
router.get(
  ...
  asyncHandler((req, res, next) =>
    insightController.getByTarget(req, res, next)
  )
);
...
router.get(
  ...
  authorize("READ_INSIGHT"),
  asyncHandler((req, res, next) =>
    insightController.listInsights(req, res, next)
  )
);
...
router.post(
  "/",
  WRITE_LIMIT,
  authorize("CREATE_INSIGHT"),
  asyncHandler((req, res, next) =>
    insightController.createInsight(req, res, next)
  )
);
...
router.get(
  ...
  validateObjectId("id"),
  asyncHandler((req, res, next) =>
    insightController.getInsightById(req, res, next)
  )
);
...
router.post(
  ...
  validateObjectId("id"),
  asyncHandler((req, res, next) =>
    insightController.markSeen(req, res, next)
  )
);
...
router.post(
  ...
  validateObjectId("id"),
  asyncHandler((req, res, next) =>
    insightController.markActed(req, res, next)
  )
);
...
router.post(
  ...
  validateObjectId("id"),
  asyncHandler((req, res, next) =>
    insightController.dismissInsight(req, res, next)
  )
);
...
router.post(
  ...
  validateObjectId("id"),
  asyncHandler((req, res, next) =>
    insightController.snoozeInsight(req, res, next)
  )
);
...
router.post(
  ...
  validateObjectId("id"),
  asyncHandler((req, res, next) =>
    insightController.submitFeedback(req, res, next)
  )
);
...
router.post(
  ...
  validateObjectId("id"),
  asyncHandler((req, res, next) =>
    insightController.archiveInsight(req, res, next)
  )
);
