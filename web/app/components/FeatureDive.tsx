...
const DETAILS = [
  { metric: "₹4.2Cr", metricLabel: "Total pipeline tracked",  accent: "#6366F1", points: ["Real-time pipeline value", "Stage-by-stage breakdown", "Team & rep performance"] },
...
export default function FeatureDive() {
  ...
  return (
    <section style={{
      ...
      {/* Mesh — accent follows active tab */}
      ...
      <div style={{ maxWidth: "var(--container)", margin: "0 auto", position: "relative" }}>
        ...
        <Reveal delay={100}>
          <div className="two-col" style={{
            ...
            <div role="tablist" aria-label="Feature modules" style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {FEATURES.map((f, i) => {
