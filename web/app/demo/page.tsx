...
export default function DemoRequestPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "var(--s-base)", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px" }}>
      <div style={{ width: "100%", maxWidth: 460 }}>

        <Link
          href="/"
          style={{ fontSize: 14, color: "var(--t-tertiary)", textDecoration: "none", display: "inline-block", marginBottom: 32 }}
        >
          ← Back to Situs
        </Link>
        ...
        {!submitted ? (
          <>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              <div>
                <label style={{ fontSize: 13, fontWeight: 600, color: "var(--t-secondary)", display: "block", marginBottom: 6 }}>
                  Full name
                </label>
                <input
                  value={name}
              ...
              <div>
                <label style={{ fontSize: 13, fontWeight: 600, color: "var(--t-secondary)", display: "block", marginBottom: 6 }}>
                  Company <span style={{ fontWeight: 400, color: "var(--t-faint)" }}>(optional)</span>
                </label>
                <input
                  value={company}
              ...
              <div>
                <label style={{ fontSize: 13, fontWeight: 600, color: "var(--t-secondary)", display: "block", marginBottom: 6 }}>
                  What are you hoping to get from the demo? <span style={{ fontWeight: 400, color: "var(--t-faint)" }}>(optional)</span>
                </label>
                <textarea
                  value={message}
